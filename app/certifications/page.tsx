    ...
    <div className="home-page min-h-screen">
      ...
      <div className="container mx-auto px-6 max-w-7xl pb-24">
        ...
        <section className="mb-24">
          <div className="max-w-4xl mx-auto home-card p-8 md:p-12 rounded-[2.5rem] relative overflow-hidden">
            {/* Background Accent */}
            ...
            <div className="flex flex-col md:flex-row gap-10 items-start relative z-10">
              <div className="w-20 h-20 bg-[linear-gradient(180deg,rgba(255,255,252,0.98),rgba(239,247,239,0.96))] rounded-3xl flex items-center justify-center text-brand-green shadow-sm border border-emerald-100/80 shrink-0">
                <ShieldCheck size={40} />
              </div>
              <div className="space-y-6 flex-grow">
                ...
                <div className="home-card backdrop-blur-sm rounded-2xl p-6">
                ...
                <div className="flex flex-wrap gap-4 pt-4">
                  ...
                  <Link 
                    href="#"
                    className="inline-flex items-center gap-2 bg-[linear-gradient(180deg,rgba(255,255,252,0.98),rgba(239,247,239,0.96))] border border-emerald-100/80 text-slate-900 px-8 py-4 rounded-full font-bold transition-all hover:shadow-sm active:scale-95"
                  >
                    <Download size={18} />
                    Download PDF
                  </Link>
        ...
        <section className="mb-24">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            {certifications.map((cert, index) => (
              <div 
                key={index}
                className="home-card p-8 rounded-3xl hover:shadow-md transition-all group"
              >
                <div className="w-16 h-16 bg-[linear-gradient(180deg,rgba(255,255,252,0.98),rgba(239,247,239,0.96))] rounded-2xl flex items-center justify-center mb-6 group-hover:scale-110 transition-transform border border-emerald-100/80">
                  {cert.icon}
                </div>
        ...
        <section className="max-w-3xl mx-auto text-center border-t border-emerald-100/70 pt-16">
